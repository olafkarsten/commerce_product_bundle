 ...
 *   },
 *   links = {
 *     "canonical" = "/admin/commerce/config/product-bundles/static/bundle-items/{commerce_static_bundle_item}",
 *     "add-page" = "/admin/commerce/config/product-bundles/static/bundle-items/add",
 *     "add-form" = "/admin/commerce/config/product-bundles/static/bundle-items/add/{commerce_static_bundle_item_type}",
 *     "edit-form" = "/admin/commerce/config/product-bundles/static/bundle-items/{commerce_static_bundle_item}/edit",
 *     "delete-form" = "/admin/commerce/config/product-bundles/static/bundle-items/{commerce_static_bundle_item}/delete",
 *     "revision" = "/admin/commerce/config/product-bundles/static/bundle-items/{commerce_static_bundle_item}/revisions/{revision}/view",
 *     "revision_revert" = "/admin/commerce/config/product-bundles/static/bundle-items/{commerce_static_bundle_item}/revisions/{revision}/revert",
 *     "translation_revert" = "/admin/commerce/config/product-bundles/static/bundle-items/{commerce_static_bundle_item}/revisions/{revision}/revert/{langcode}",
 *     "revision_delete" = "/admin/commerce/config/product-bundles/static/bundle-items/{commerce_static_bundle_item}/revisions/{revision}/delete",
 *     "collection" = "/admin/commerce/config/product-bundles/static/bundle-items",
 *   },
