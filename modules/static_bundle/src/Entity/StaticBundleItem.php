 ...
 *     "translation_revert" = "/admin/commerce/config/product-bundles/static/bundle-items/{commerce_static_bundle_item}/revisions/{commerce_static_bundle_item_revision}/revert/{langcode}",
