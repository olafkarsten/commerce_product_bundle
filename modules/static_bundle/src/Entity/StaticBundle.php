 ...
 *     "revision" = "/admin/commerce/config/product-bundles/static/{commerce_static_bundle}/revisions/{commerce_static_bundle_revision}/view",
 *     "revision_revert" = "/admin/commerce/config/product-bundles/static/{commerce_static_bundle}/revisions/{commerce_static_bundle_revision}/revert",
 *     "translation_revert" = "/admin/commerce/config/product-bundles/static/{commerce_static_bundle}/revisions/{commerce_static_bundle_revision}/revert/{langcode}",
 *     "revision_delete" = "/admin/commerce/config/product-bundles/static/{commerce_static_bundle}/revisions/{commerce_static_bundle_revision}/delete",
