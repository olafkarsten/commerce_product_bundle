 ...
 *   revision_table = "commerce_static_bundle_revision",
 *   revision_data_table = "commerce_static_bundle_field_revision",
 *   translatable = TRUE,
 ...
 *   },
 *   links = {
 *     "canonical" = "/admin/commerce/config/product-bundles/static/{commerce_static_bundle}",
 *     "add-page" = "/admin/commerce/config/product-bundles/static/add",
 *     "add-form" = "/admin/commerce/config/product-bundles/static/add/{commerce_static_bundle_type}",
 *     "edit-form" = "/admin/commerce/config/product-bundles/static/{commerce_static_bundle}/edit",
 *     "delete-form" = "/admin/commerce/config/product-bundles/static/{commerce_static_bundle}/delete",
 *     "version-history" = "/admin/commerce/config/product-bundles/static/{commerce_static_bundle}/revisions",
 *     "revision" = "/admin/commerce/config/product-bundles/static/{commerce_static_bundle}/revisions/{revision}/view",
 *     "revision_revert" = "/admin/commerce/config/product-bundles/static/{commerce_static_bundle}/revisions/{revision}/revert",
 *     "translation_revert" = "/admin/commerce/config/product-bundles/static/{commerce_static_bundle}/revisions/{revision}/revert/{langcode}",
 *     "revision_delete" = "/admin/commerce/config/product-bundles/static/{commerce_static_bundle}/revisions/{revision}/delete",
 *     "collection" = "/admin/commerce/config/product-bundles/static",
 *   },
