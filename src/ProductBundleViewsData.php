...
class ProductBundleViewsData extends EntityViewsData implements EntityViewsDataInterface {
  ...
  public function getViewsData() {
    ...
    if (in_array($entity_type_id,
      ...
      // No need for a reverse relationship.
      unset($entity_reference_fields['bundle_items']);
    }
   ...
   *   The bundle field.
   */
  protected function addBundleFieldData(
    array &$data,
    BundleFieldDefinition $bundle_field
  ) {
   ...
   * {@inheritdoc}
   */
  protected function mapFieldDefinition(
    $table,
    $field_name,
   ...
   */
  protected function processViewsDataForCommercePrice(
    $table,
    FieldDefinitionInterface $field_definition,
    array &$views_field,
    $field_column_name
   ...
   *   The field column being processed.
   */
  protected function processViewsDataForDatetime(
    $table,
    FieldDefinitionInterface $field_definition,
    array &$views_field,
    $field_column_name
   ...
   *   The field column being processed.
   */
  protected function processViewsDataForListFloat(
    $table,
    FieldDefinitionInterface $field_definition,
    array &$views_field,
    $field_column_name
   ...
   *   The field column being processed.
   */
  protected function processViewsDataForListInteger(
    $table,
    FieldDefinitionInterface $field_definition,
    array &$views_field,
    $field_column_name
   ...
   *   The field column being processed.
   */
  protected function processViewsDataForListString(
    $table,
    FieldDefinitionInterface $field_definition,
    array &$views_field,
    $field_column_name
   ...
   *   The field column being processed.
   */
  protected function processViewsDataForState(
    $table,
    FieldDefinitionInterface $field_definition,
    array &$views_field,
    $field_column_name
