 ...
 */
class ProductBundleItemRevisionRevertForm extends ConfirmFormBase {
  ...
  public function getFormId() {
    return 'commerce_product_bundle_item_revision_revert_confirm';
  }
  ...
  public function getCancelUrl() {
    return new Url('entity.commerce_product_bundle_item.version_history', array('commerce_product_bundle_item' => $this->revision->id()));
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->logger('content')->notice('Product bundle item: reverted %title revision %revision.', ['%title' => $this->revision->label(), '%revision' => $this->revision->getRevisionId()]);
    drupal_set_message(t('Product bundle item %title has been reverted to the revision from %revision-date.', ['%title' => $this->revision->label(), '%revision-date' => $this->dateFormatter->format($original_revision_timestamp)]));
